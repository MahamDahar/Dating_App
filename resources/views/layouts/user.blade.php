...
<body>
                ...
                <li>
                  <a class="dropdown-item" href="javascript:;">
                    <div class="d-flex flex-row align-items-center gap-2">
                      <img src="{{('admin/assets/images/avatars/06.png')}}" alt="" class="rounded-circle" width="54" height="54">
                      <div class="">
 ...
 <!--Start Back To Top Button-->
  ...
  <script type="admin/module" src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.esm.js"></script>
  <!--plugins-->
