                ...
                <form action="{{ route('user.settings.notifications.push.update') }}" method="POST">
                    ...
                    <div class="notif-row border-bottom">
                        ...
                        <div class="form-check form-switch mb-0">
                            <input class="form-check-input notify-toggle" type="checkbox"
                                name="push_new_match" id="push_new_match" role="switch"
                    ...
                    <div class="d-flex align-items-center justify-content-between p-3 rounded-3 mb-4 master-toggle-box">
                        <div class="d-flex align-items-center gap-2">
                            <ion-icon name="notifications-off-outline" style="font-size:18px;color:#7c3aed;"></ion-icon>
                            <span class="fw-medium" style="font-size:14px;color:#7c3aed;">Disable All Push Notifications</span>
                        </div>
