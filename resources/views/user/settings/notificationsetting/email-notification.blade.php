                            ...
                            <form action="{{ route('user.settings.notifications.email.update') }}" method="POST">
                                ...
                                <div class="notif-row border-bottom">
                                    ...
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input notify-toggle" type="checkbox" name="email_new_match"
                                            id="email_new_match" role="switch"
                                ...
                                {{-- Info box --}}
                                <div class="d-flex align-items-start gap-2 p-3 rounded-3 mb-4"
                                    style="background:#fffbeb;border:1px solid #fde68a;">
                                    <ion-icon name="information-circle-outline"
                                        style="font-size:18px;color:#d97706;flex-shrink:0;margin-top:1px;"></ion-icon>
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <ion-icon name="notifications-off-outline"
                                            style="font-size:18px;color:#f59e0b;"></ion-icon>
                                        <span class="fw-medium" style="font-size:14px;color:#f59e0b;">Disable All Email
                                            Notifications</span>
                                    </div>
